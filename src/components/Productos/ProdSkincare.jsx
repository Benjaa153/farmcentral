...
import Skincare2 from '../../images/productos2.jpeg';
import Skincare3 from '../../images/productos3.jpeg';

function Prodskincare() {
  return (
    <div>
      <section className="flex flex-wrap justify-center pb-24 container mx-auto" >
        <div className="flex flex-col mb-5 px-4 w-full sm:w-1/2 md:w-1/3">
          <img src={Skincare1} alt="Ultra estructura" data-aos="fade-down" className="mb-5"/>
          <h3 className="text-2xl text-darkcyan uppercase font-lora mb-4 text-center " data-aos="fade-down">Ultra estructura</h3>
          <p className="text-lg text-black" data-aos="fade-up">Es un elixir nocturno diseñado para revitalizar la piel mientras descansas. 
        ...
        <div className="flex flex-col mb-5 px-4 w-full sm:w-1/2 md:w-1/3">
          <img src={Skincare2} alt="Ultra hidratacion" data-aos="fade-down" className="mb-5"/>
          <h3 className="text-2xl text-darkcyan uppercase font-lora mb-4 text-center" data-aos="fade-down">Ultra hidratacion</h3>
          <p data-aos="fade-up">La Crema Facial Dermaglós Ultra Hidratación en Gel es una solución innovadora para mantener la piel hidratada 
        ...
        <div className="flex flex-col mb-5 px-4 w-full sm:w-1/2 md:w-1/3">
          <img src={Skincare3} alt="Limpieza profunda" data-aos="fade-down" className="mb-5"/>
          <h3 className="text-2xl text-darkcyan uppercase font-lora mb-4 text-center">Limpieza profunda</h3>
          <p data-aos="fade-up">El Gel de Limpieza Profunda Aveno es un producto excepcional para quienes buscan una limpieza facial y corporal 

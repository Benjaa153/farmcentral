    ...
    return (
        <div className='flex items-center justify-center mb-2'>
            ...
            <div className='relative w-full sm:w-[320px] md:w-[480px] lg:w-[640px] h-[400px] flex flex-col justify-between z-10'>
                ...
                {/* container */}
                <div className='relative w-full h-[150px] bg-keppel rounded-2xl rounded-tl-none'>
                    <span className='absolute left-0 w-1/2 h-[80px] -top-[80px] bg-keppel border-t-[10px] border-r-[10px] border-white rounded-tr-[25px]'>
                        ...
                        <button onClick={() => setIsModalOpen(true)} className='relative bg-sombra py-2 px-4 m-3 block rounded-lg font-lora text-center text-white transform hover:scale-105 transition-transform'>
                            VER MAS
                        </button>
                    </span>
                    <div className="bg-darkcyan p-4 rounded-2xl rounded-tl-none">
                        <h1 className="text-2xl lg:text-3xl xl:text-2xl font-lora mb-2 text-white">Protector solar: </h1>
            ...
            {isModalOpen && (
                <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
                    <div className={`bg-darkcyan p-5 rounded-lg w-11/12 sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-1/2 max-h-[90vh] overflow-y-auto 
                    ${isModalOpen ? 'animate-fade-in' : 'animate-fade-out'}`}>
                        ...
                        <div className="relative flex w-full flex-col rounded-xl bg-white text-gray-700 shadow-md">
                            ...
                            <div className="p-6 space-y-4">
                                <h5 className="mb-2 block text-xl font-lora leading-snug text-blue-gray-900">
                                    Recomendaciones
                                </h5>
                                <ul className="list-disc space-y-2 pl-5 text-base font-lora">
                                    <li>
                        ...
                        <button onClick={() => setIsModalOpen(false)} className='relative bg-keppel py-2 px-4 m-3 
                        block rounded-lg font-lora text-center text-white transform hover:scale-105 transition-transform'>
                        Cerrar</button>
                    </div>
                </div>
            )}
